...
- **Application tracker** — one button, one tap per job application. Today / last 7 days / per-day average, and a 14-day bar chart. Undo reverses the last tap; **view log** opens the full history grouped by day, where you can delete a single mistaken entry or clear a whole day at once.
